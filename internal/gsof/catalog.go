...
var Catalog = map[int]Message{
	...
	99:  {99, "Extended GSOF records", "Carrier for extended output record types (≥100); expanded before decode in this tool.", "https://docs.google.com/document/d/1QB-CwxMv0bkDW2hsJG7RIZe8BEFrXeKdjXKhpUPUv6Y/edit?usp=sharing"},
