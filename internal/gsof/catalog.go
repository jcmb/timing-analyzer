...
var Catalog = map[int]Message{
	1:  {1, "Position time", "Position and time (antenna phase center).", ""},
	2:  {2, "Latitude, longitude, height", "Latitude, longitude, height.", ""},
	3:  {3, "ECEF position", "Earth-centered, Earth-fixed position.", ""},
	...
	6:  {6, "ECEF delta", "Earth-centered, Earth-fixed delta position.", ""},
	7:  {7, "Tangent plane delta", "Tangent plane delta.", ""},
	8:  {8, "Velocity data", "Velocity data.", ""},
	9:  {9, "PDOP info", "PDOP information.", ""},
	10: {10, "Clock info", "Clock information.", ""},
	11: {11, "Position VCV info", "Position variance-covariance (VCV) information.", ""},
	12: {12, "Position sigma", "Position sigma information.", ""},
